...
#include "storage/peloton/configuration/configuration.h"
...
// Layout mode
int peloton_layout_mode = 1;//LAYOUT_TYPE_ROW;

// Logging mode
LoggingType peloton_logging_mode = LoggingType::INVALID;
