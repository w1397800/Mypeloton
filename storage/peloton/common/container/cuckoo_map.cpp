...
template class CuckooMap<uint, std::shared_ptr<TileGroup>>;

// Used in Shared Pointer test and iterator test
template class CuckooMap<uint, std::shared_ptr<uint>>;
...
template class CuckooMap<std::shared_ptr<uint>, std::shared_ptr<uint>>;
