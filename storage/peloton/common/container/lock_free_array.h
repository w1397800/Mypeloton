...
class LockFreeArray {
 public:
   ...
   */
  void Update(const size_t &offset, const ValueType &value);
   ...
   */
  ValueType Find(const size_t &offset) const;
   ...
   */
  ValueType FindValid(const size_t &offset,
   ...
   */
  void Erase(const size_t &offset, const ValueType &invalid_value);
 ...
 private:
  // lock free array
  concurrent_vector<ValueType, zero_allocator<ValueType>>
      lock_free_array;
};
