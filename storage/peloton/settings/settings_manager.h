...
class SettingsManager {
 ...
 private:
  ...
  struct Param {
    ...
    Param(std::string name, const Value &value,
          std::string desc, const Value &default_value,
  ...
  Value GetValue(SettingId id);

  void SetValue(SettingId id, const Value &value);
