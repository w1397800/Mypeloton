...
//    setting definitions will be exposed through SettingId.
  ...
  #define SETTING_int(name, description, default_value, min_value, max_value, is_mutable, is_persistent)      \
      DefineSetting(                                                                                          \
        SettingId::name,                                                                   \
        #name, ValueFactory::GetIntegerValue(FLAGS_##name),                                             \
        description, ValueFactory::GetIntegerValue(default_value),                                      \
        ValueFactory::GetIntegerValue(min_value),                                                       \
        ValueFactory::GetIntegerValue(max_value),                                                       \
        is_mutable, is_persistent);

  #define SETTING_double(name, description, default_value, min_value, max_value, is_mutable, is_persistent)   \
      DefineSetting(                                                                                          \
        SettingId::name,                                                                   \
        #name, ValueFactory::GetDecimalValue(FLAGS_##name),                                             \
        description, ValueFactory::GetDecimalValue(default_value),                                      \
        ValueFactory::GetDecimalValue(min_value),                                                       \
        ValueFactory::GetDecimalValue(max_value),                                                       \
        is_mutable, is_persistent);

  #define SETTING_bool(name, description, default_value, is_mutable, is_persistent)                           \
      DefineSetting(                                                                                          \
        SettingId::name,                                                                   \
        #name, ValueFactory::GetBooleanValue(FLAGS_##name),                                             \
        description, ValueFactory::GetBooleanValue(default_value),                                      \
        ValueFactory::GetBooleanValue(default_value),                                                   \
        ValueFactory::GetBooleanValue(default_value),                                                   \
        is_mutable, is_persistent);
  ...
  #define SETTING_string(name, description, default_value, is_mutable, is_persistent)                         \
      DefineSetting(                                                                                          \
        SettingId::name,                                                                   \
        #name, ValueFactory::GetVarcharValue(FLAGS_##name),                                             \
        description, ValueFactory::GetVarcharValue(default_value),                                      \
        ValueFactory::GetVarcharValue(default_value),                                                   \
        ValueFactory::GetVarcharValue(default_value),                                                   \
        is_mutable, is_persistent);
#endif
