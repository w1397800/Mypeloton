...
public:
  ...
  /**
   * @brief      Sets the current txn identifier.
   *
   * @param[in]  txn_id  The txn identifier
   */
  virtual void SetCurrentTxnId(const uint32_t txn_id) = 0;
  ...
  virtual cid_t EnterEpoch(const size_t thread_id, const TimestampType1 timestamp_type) = 0;
...
/**
   ...
   */
  virtual uint32_t GetCurrentTxnId() = 0;  
  /**
