...
#ifndef AFFF9D3E_FFD8_4CC2_91FB_9C1BEB248B4E
#define AFFF9D3E_FFD8_4CC2_91FB_9C1BEB248B4E
...
public:
    ...
    virtual std::shared_ptr<LogEntry> get_entry(const int64_t index) = 0;

    // get logentry's term by index
    virtual int64_t get_term(const int64_t index) = 0;

    // append entries to log
    virtual int append_entry(const std::shared_ptr<LogEntry> entry) = 0;
...
#endif /* AFFF9D3E_FFD8_4CC2_91FB_9C1BEB248B4E */
