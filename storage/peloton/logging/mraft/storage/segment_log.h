...
#ifndef B076891A_F03C_49AF_97DE_1BCCBBFE7B11
#define B076891A_F03C_49AF_97DE_1BCCBBFE7B11
...
public:
    ...
    int append(const std::shared_ptr<LogEntry> entry);

    // get entry by index
    std::shared_ptr<LogEntry> get(const int64_t index) const;
...
public:
    ...
    virtual std::shared_ptr<LogEntry> get_entry(const int64_t index);
    ...
    virtual int append_entries(const std::vector<std::shared_ptr<LogEntry>> &entries,
...
#endif /* B076891A_F03C_49AF_97DE_1BCCBBFE7B11 */
