...
#define DATABASE_OID_MASK (static_cast<uint>(CatalogType::DATABASE))
#define SCHEMA_OID_MASK (static_cast<uint>(CatalogType::SCHEMA))
#define TABLE_OID_MASK (static_cast<uint>(CatalogType::TABLE))
#define INDEX_OID_MASK (static_cast<uint>(CatalogType::INDEX))
#define TRIGGER_OID_MASK (static_cast<uint>(CatalogType::TRIGGER))
#define LANGUAGE_OID_MASK (static_cast<uint>(CatalogType::LANGUAGE))
#define PROC_OID_MASK (static_cast<uint>(CatalogType::PROC))
#define CONSTRAINT_OID_MASK (static_cast<uint>(CatalogType::CONSTRAINT))
