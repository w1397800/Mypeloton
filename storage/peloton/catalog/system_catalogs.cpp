...
// system_catalog.cpp
//
// Identification: src/system_catalog.cpp
//
 ...
 */
SystemCatalogs::SystemCatalogs(TransactionContext *txn,
                               Database *database,
                               AbstractPool *pool)
    : pg_trigger_(nullptr),
  ...
  std::vector<std::pair<uint, uint>> shared_tables = {
 ...
 * @param   txn              TransactionContext
 */
void SystemCatalogs::Bootstrap(TransactionContext *txn,
